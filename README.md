![docker image](https://github.com/Bondoki/tmp-nomad-docker-v1.4.2/actions/workflows/docker-publish.yml/badge.svg)


# Bondoki's NOMAD Oasis Distribution

This is the NOMAD Oasis distribution of Bondoki.
...
2. Clone the repository or download the repository as a zip file.
    ...
    ```sh
    git clone https://github.com/Bondoki/tmp-nomad-docker-v1.4.2.git
    cd tmp-nomad-docker-v1.4.2
    ```

    or

    ```sh
    curl-L -o tmp-nomad-docker-v1.4.2.zip "https://github.com/Bondoki/tmp-nomad-docker-v1.4.2/archive/main.zip"
    unzip tmp-nomad-docker-v1.4.2.zip
    cd tmp-nomad-docker-v1.4.2
    ```
...
your `docker-compose.yaml` with `ghcr.io/bondoki/tmp-nomad-docker-v1.4.2:main` for the services
...
and advanced configuration, see the [nomad-helm-charts](https://github.com/Bondoki/nomad-helm-charts) repository.
...
By default, no plugins are included in this distribution. You can find a list of available NOMAD plugins [here](https://nomad-lab.eu/prod/v1/oasis/gui/search/plugins). For a list of official plugins provided by FAIRmat, please see [here](https://github.com/Bondoki/.github/blob/main/profile/README.md). For inspiration, you can also check the list of [plugins that are installed on the production NOMAD deployment hosted by FAIRmat](https://gitlab.mpcdf.mpg.de/nomad-lab/nomad-distro/-/raw/main/pyproject.toml?ref_type=heads).
...
```sh
docker pull ghcr.io/bondoki/tmp-nomad-docker-v1.4.2/jupyter:main
```
...
By default, documentation is built using the [nomad-docs](https://github.com/Bondoki/nomad-docs) repository. However, if you'd like to customize the documentation for your Oasis instance, you can easily do so.

1. First, [fork the nomad-docs repository](https://github.com/Bondoki/nomad-docs/fork).
...
_I get an_ `Error response from daemon: Head "https://ghcr.io/v2/Bondoki/tmp-nomad-docker-v1.4.2/manifests/main": unauthorized`
